...
const AsynchronousMachineKindEnum = {
        generator:0,
        motor:1,
}
const possibleValues = [
        { "value": "--"},
        { "value": "AsynchronousMachineKind.generator", "label": "generator" },
        { "value": "AsynchronousMachineKind.motor", "label": "motor" },
]

class AsynchronousMachineKind extends BaseClass {

    static attributeHTML(object, cimmenu, classType="AsynchronousMachineKind") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = AsynchronousMachineKind.attributeHTML(object, cimmenu);
...
export default AsynchronousMachineKind
