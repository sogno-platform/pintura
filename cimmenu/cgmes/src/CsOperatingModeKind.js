...
const CsOperatingModeKindEnum = {
        inverter:0,
        rectifier:1,
}
const possibleValues = [
        { "value": "--"},
        { "value": "CsOperatingModeKind.inverter", "label": "inverter" },
        { "value": "CsOperatingModeKind.rectifier", "label": "rectifier" },
]

class CsOperatingModeKind extends BaseClass {

    static attributeHTML(object, cimmenu, classType="CsOperatingModeKind") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = CsOperatingModeKind.attributeHTML(object, cimmenu);
...
export default CsOperatingModeKind
