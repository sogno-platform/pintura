...
class ThermalGeneratingUnit extends GeneratingUnit {
    ...
    static attributeHTML(object, cimmenu, classType="ThermalGeneratingUnit") {
    ...
    static read(object) {
        Object.keys(object).forEach((attribute) => {
            if (!ThermalGeneratingUnit.isMemberAttribute(attribute)) {
                console.error("Unexpected attribute for class ThermalGeneratingUnit: ", attribute, " with value: ", object[attribute])
            }
        });
    }
    static renderAsClass(object, cimmenu) {
        let separateEntries = ThermalGeneratingUnit.attributeHTML(object, cimmenu);
...
export default ThermalGeneratingUnit
