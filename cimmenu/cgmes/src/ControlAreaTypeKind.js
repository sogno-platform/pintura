...
const possibleValues = [
        { "value": "--"},
        { "value": "ControlAreaTypeKind.AGC", "label": "AGC" },
        { "value": "ControlAreaTypeKind.Forecast", "label": "Forecast" },
        { "value": "ControlAreaTypeKind.Interchange", "label": "Interchange" },
]

class ControlAreaTypeKind extends BaseClass {

    static attributeHTML(object, cimmenu, classType="ControlAreaTypeKind") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = ControlAreaTypeKind.attributeHTML(object, cimmenu);
...
export default ControlAreaTypeKind
