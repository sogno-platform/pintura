...
class WindAeroConstIEC extends IdentifiedObject {

    static attributeHTML(object, cimmenu, classType="WindAeroConstIEC") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = WindAeroConstIEC.attributeHTML(object, cimmenu);
...
export default WindAeroConstIEC
