...
class SolarGeneratingUnit extends GeneratingUnit {
    ...
    static attributeHTML(object, cimmenu, classType="SolarGeneratingUnit") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = SolarGeneratingUnit.attributeHTML(object, cimmenu);
...
export default SolarGeneratingUnit
