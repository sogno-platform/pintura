...
class DiagramObjectStyle extends IdentifiedObject {

    static attributeHTML(object, cimmenu, classType="DiagramObjectStyle") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = DiagramObjectStyle.attributeHTML(object, cimmenu);
...
export default DiagramObjectStyle
