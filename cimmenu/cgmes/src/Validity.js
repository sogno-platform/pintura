...
const possibleValues = [
        { "value": "--"},
        { "value": "Validity.GOOD", "label": "GOOD" },
        { "value": "Validity.QUESTIONABLE", "label": "QUESTIONABLE" },
        { "value": "Validity.INVALID", "label": "INVALID" },
]

class Validity extends BaseClass {

    static attributeHTML(object, cimmenu, classType="Validity") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = Validity.attributeHTML(object, cimmenu);
