...
class EnergySchedulingType extends IdentifiedObject {

    static attributeHTML(object, cimmenu, classType="EnergySchedulingType") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = EnergySchedulingType.attributeHTML(object, cimmenu);
...
export default EnergySchedulingType
