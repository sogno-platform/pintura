...
const possibleValues = [
        { "value": "--"},
        { "value": "FuelType.coal", "label": "coal" },
        { "value": "FuelType.oil", "label": "oil" },
        { "value": "FuelType.gas", "label": "gas" },
        { "value": "FuelType.lignite", "label": "lignite" },
        { "value": "FuelType.hardCoal", "label": "hardCoal" },
        { "value": "FuelType.oilShale", "label": "oilShale" },
]

class FuelType extends BaseClass {

    static attributeHTML(object, cimmenu, classType="FuelType") {
    ...
    static renderAsClass(object, cimmenu) {
        let separateEntries = FuelType.attributeHTML(object, cimmenu);
