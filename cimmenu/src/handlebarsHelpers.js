...
Handlebars.registerHelper('sort_each_by_pintura_label', function(context, options) {
    return customEachFunction(context, options, function(context) {
...
Handlebars.registerHelper('sort_each_by_identified_object_name', function(context, options) {
    return customEachFunction(context, options, function(context) {
        let contextSortedById = {};
        Object.keys(context).sort((a, b)=>{
