...
COPY --from=builder /pintura/generated/template.js /usr/share/nginx/html/templates/
COPY --from=builder /pintura/generated/add_components_menu.xml /usr/share/nginx/html/templates/
